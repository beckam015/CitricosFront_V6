...
export class Grafica5Component implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.salesData.datasets[0].data = this.grafica.listNitrogeno;
    this.salesData.datasets[1].data = this.grafica.listPotasio;
  ...
  chartOptions: ChartOptions = {
    ...
    plugins: {
      title: {
        display: true,
        text: 'Resultados de los nutrientes del suelo:',
      },
    },
  };
  Graficar1() {
    ...
    this.salesData.datasets[0].data = this.rtaDatos.listNitrogeno;
    this.salesData.datasets[1].data = this.rtaDatos.listPotasio;
